"""
Django settings for infoctess project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-infoctess-secret-key-change-this-in-production')
...
WSGI_APPLICATION = 'infoctess.wsgi.application'
